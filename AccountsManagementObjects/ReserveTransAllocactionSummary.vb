Public Class ReserveTransAllocationSummary
    ...
    Private _ASPenalty As Decimal
    Public Property ASPenalty() As Decimal
        Get
            Return _ASPenalty
        End Get
        Set(ByVal value As Decimal)
    ...
    Private _ListRESAllocDetails As List(Of ReserveTransAllocationDetails)
    Public Property ListRESAllocDetails() As List(Of ReserveTransAllocationDetails)
        Get
            Return _ListRESAllocDetails
        End Get
        Set(ByVal value As List(Of ReserveTransAllocationDetails))
            _ListRESAllocDetails = value
        End Set
    End Property
