Public Class BIRRulingDetails
    ...
    Public ReadOnly Property NetSale() As Decimal
        Get
            Return (_VatableSales + _ZeroRatedSales + _ZeroRatedEcoZone)
        End Get
    End Property

    Public ReadOnly Property Total() As Decimal
        Get
            Return (_VatableSales + _ZeroRatedSales + _ZeroRatedEcoZone + _VatOnSales + _WithholdingTax)
        End Get
    End Property
End Class
