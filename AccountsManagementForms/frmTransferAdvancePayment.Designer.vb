...
Partial Class frmTransferAdvancePayment
    ...
    Private Sub InitializeComponent()
        ...
        Me.colBPIAccount.HeaderText = "IEMOPAccount"
    ...
    Friend WithEvents colColNo As DataGridViewTextBoxColumn
    Friend WithEvents colORNo As DataGridViewTextBoxColumn
    Friend WithEvents colIDNumber As DataGridViewTextBoxColumn
    Friend WithEvents colParticipantID As DataGridViewTextBoxColumn
    Friend WithEvents colAutoHeld As DataGridViewTextBoxColumn
    Friend WithEvents colUnallocated As DataGridViewTextBoxColumn
    Friend WithEvents colExcessCollection As DataGridViewTextBoxColumn
    Friend WithEvents colManualHeld As DataGridViewTextBoxColumn
    Friend WithEvents colPrudential As DataGridViewTextBoxColumn
    Friend WithEvents colBPIAccount As DataGridViewTextBoxColumn
End Class
