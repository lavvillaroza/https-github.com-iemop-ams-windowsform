...
'Form Name:              frmSLAccountsPayable
'Orginal Author:         Vladimir E. Espiritu
'File Creation Date:     October 09, 2015
'Development Group:      Software Development and Support Division
'Description:            GUI for the generation of SL-AP
...
'   Oct. 21 2020            Lance Arjay Villaroza                Correction of SL to add offsetting JV
...
Public Class frmSLAccountsPayable
    Private BFactory As BusinessFactory
    Private WBillHelper As WESMBillHelper
    Private dicParticipants As Dictionary(Of String, AMParticipants)

    Private Sub frmSLAccountsPayable_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            'Populate the list of Participants in dropdown control
    ...
    Private Sub cmd_Generate_Click(sender As Object, e As EventArgs) Handles cmd_Generate.Click
        Dim listWESMBillSummaryFromPaymentAllocation As List(Of WESMBillSummaryTransaction)        
        ...
        Dim listSubsidiaryLedgerAP As New List(Of SubsidiaryLedgerAP)
        Dim itemGenerate As New FuncGenerateWESMBillSummaryTransactionAP
        ...
        Try
            ...
            ProgressThread.Show("Please wait while preparing SL Accounts Payable Report.")
            If Me.ddlParticipantID.SelectedIndex = 0 Then
                For Each item In Me.dicParticipants.Keys                    
                    ...
                    listWESMBillSummaryFromPaymentAllocation = (From x In WBillHelper.GetWESMBillSummaryFromPaymentAllocationForAP(itemParticipant.IDNumber, transactionDate) Order By x.TransactionDate).ToList()
                    ...
                    listWESMBillSummaryFromSPA = WBillHelper.GetWESMBillSummaryFromSPA(itemParticipant.IDNumber, transactionDate, EnumBalanceType.AP)
                    listWESMBillSummaryWithInvoice = WBillHelper.GetWESMBillSummaryWithInvoice(itemParticipant.IDNumber, transactionDate, EnumBalanceType.AP)

                    itemGenerate.TransactionDate = transactionDate                    
                    itemGenerate.ListOfWESMBillTransactionPaymentAllocation = listWESMBillSummaryFromPaymentAllocation
                    ...
                    listSubsidiaryLedgerAP = itemGenerate.PopulateSubsidiaryLedger()

                    'Generate the Datatable
                    BFactory.GenerateSubsidiaryLedgerAccountsPayablePerParticipant(itemParticipant, listSubsidiaryLedgerAP, dt)
            ...
            With rptView
                .LoadSLAccountsPayablePerParticipant(result, transactionDate.AddDays(-1))
                ProgressThread.Close()
                .ShowDialog()
            End With
        ...
        Try
            ...
            With _fldrSelect
                ...
                If .SelectedPath = "" Then
                    Exit Sub
                End If
                fPathName = .SelectedPath & "\SL_AccountPayable_" & Format(Me.dtTransaction.Value, "MMddyyyy") & ".csv"
            End With
