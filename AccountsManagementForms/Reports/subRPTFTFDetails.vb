...
Public Class subRPTFTFDetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AccountsManagementForms.subRPTFTFDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedsubRPTFTFDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As subRPTFTFDetails = New subRPTFTFDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
