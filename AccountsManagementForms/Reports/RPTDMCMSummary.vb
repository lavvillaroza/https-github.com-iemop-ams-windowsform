...
Public Class RPTDMCMSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AccountsManagementForms.RPTDMCMSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTDMCMSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTDMCMSummary = New RPTDMCMSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
