...
Public Class RPTDebitCreditMemo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AccountsManagementForms.RPTDebitCreditMemo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTDebitCreditMemo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTDebitCreditMemo = New RPTDebitCreditMemo()
        rpt.Site = Me.Site
        Return rpt
    End Function
