...
Public Class RPTDrawdown
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AccountsManagementForms.RPTDrawdown.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTDrawdown
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTDrawdown = New RPTDrawdown()
        rpt.Site = Me.Site
        Return rpt
    End Function
