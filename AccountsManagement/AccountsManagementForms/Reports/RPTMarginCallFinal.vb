...
Public Class RPTMarginCallFinal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AccountsManagementForms.RPTMarginCallFinal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTMarginCallFinal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTMarginCallFinal = New RPTMarginCallFinal()
        rpt.Site = Me.Site
        Return rpt
    End Function
