...
Public Class RPTCheckRegister
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AccountsManagementForms.RPTCheckRegister.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTCheckRegister
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTCheckRegister = New RPTCheckRegister()
        rpt.Site = Me.Site
        Return rpt
    End Function
