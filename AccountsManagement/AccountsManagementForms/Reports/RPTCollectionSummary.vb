...
Public Class RPTCollectionSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AccountsManagementForms.RPTCollectionSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTCollectionSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTCollectionSummary = New RPTCollectionSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
