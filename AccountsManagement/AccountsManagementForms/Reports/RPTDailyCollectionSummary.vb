...
Public Class RPTDailyCollectionSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AccountsManagementForms.RPTDailyCollectionSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTDailyCollectionSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTDailyCollectionSummary = New RPTDailyCollectionSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
