...
Public Class RPTFTFMainDraft
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AccountsManagementForms.RPTFTFMainDraft.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTFTFMainDraft
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTFTFMainDraft = New RPTFTFMainDraft()
        rpt.Site = Me.Site
        Return rpt
    End Function
