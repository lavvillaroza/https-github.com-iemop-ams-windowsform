...
Public Class RPTReserveTransAllocationSummary
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPTReserveTransAllocationSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AccountsManagementForms.RPTReserveTransAllocationSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTReserveTransAllocationSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTReserveTransAllocationSummary = New RPTReserveTransAllocationSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
