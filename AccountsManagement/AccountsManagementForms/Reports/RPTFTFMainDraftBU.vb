...
Public Class RPTFTFMainDraftBU
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AccountsManagementForms.RPTFTFMainDraftBU.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTFTFMainDraftBU
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTFTFMainDraftBU = New RPTFTFMainDraftBU()
        rpt.Site = Me.Site
        Return rpt
    End Function
