...
Public Class RPTMarketFees
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AccountsManagementForms.RPTMarketFees.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTMarketFees
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTMarketFees = New RPTMarketFees()
        rpt.Site = Me.Site
        Return rpt
    End Function
