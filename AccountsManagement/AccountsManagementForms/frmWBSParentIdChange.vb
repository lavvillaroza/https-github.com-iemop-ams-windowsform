        ...
        Try
            ...
            If Not WBSChangeParticipantIDList.Count = 0 Then
                ...
                For Each item In WBSChangeParticipantIDList
                    Me.dgv_wbsChangeParentId.Rows.Add(item.ParentParticipants.IDNumber, item.ParentParticipants.ParticipantID, item.ChildParticipants.IDNumber, _
                                                         item.ChildParticipants.ParticipantID, item.NewParentParticipants.IDNumber, item.NewParentParticipants.ParticipantID, _
