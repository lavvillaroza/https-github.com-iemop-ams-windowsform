Public Class ImportWTAFromCRSS
    ...
    Private _WTACoverSummaryList As List(Of WESMBillAllocCoverSummary)
    Public Property WTACoverSummaryList() As List(Of WESMBillAllocCoverSummary)
        Get
            Return _WTACoverSummaryList
        End Get
        Set(ByVal value As List(Of WESMBillAllocCoverSummary))
            _WTACoverSummaryList = value
        End Set
    End Property
