...
Public Class WHTaxCertificateSTLHelperNew
    Public Sub New()
...
#Region "Search By Date"
    Public Async Function GetListOfWTCertStl(ByVal dateFrom As Date, ByVal dateTo As Date, ByVal notAllocated As Boolean, ByVal notUntagged As Boolean) As Task(Of List(Of WHTaxCertificateSTL))
        ...
        Try
            ...
            End If
            ret = Await Me.GetListOfWTCertStl(report.ReturnedIDatareader)
        Catch ex As Exception
            Throw New ApplicationException(ex.Message)
        End Try
        Return ret
    End Function
    Private Function GetListOfWTCertStl(ByVal dr As IDataReader) As Task(Of List(Of WHTaxCertificateSTL))
